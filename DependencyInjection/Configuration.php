        ...
        $node
            ...
            ->prototype('array')
                ->children()
                    ...
                    ->end()
                    ->arrayNode('stomp')
                        ->info('Validate that a ActiveMQ(stomp) service is running')
                        ->useAttributeAsKey('name')
                        ->prototype('array')
                            ->children()
                                ->scalarNode('broker')->defaultValue('tcp://localhost:61613')->end()
                    ...
                    ->arrayNode('elasticsearch')
                        ->info('Validate that a elasticsearch service is running')
                        ->useAttributeAsKey('name')
                        ->prototype('array')
                            ->children()
                                ->scalarNode('host')->defaultValue('tcp://localhost:61613')->end()
                                ->booleanNode('ssl_verification')->defaultFalse()->end()
                            ->end()
                        ->end()
                    ->end()
